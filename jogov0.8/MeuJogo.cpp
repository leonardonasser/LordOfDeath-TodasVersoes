...
BITMAP *toco,*folhas,*pontecastelo;
//vida do chefao
BITMAP *vidachefao,*vidachefao1,*vidachefao2,*vidachefao3,*vidachefao4,*vidachefao5,*vidachefao6;
BITMAP *vidachefao7,*vidachefaofinal,*chefaosp,*vidachefaodnv,*tutorial,*historiainicio;
...
void historia(){     
    ...
    if(HistoriaS_N==0){ 
     ...
     if(key[KEY_N]){break;}
       ...
       if(mudarimagens==0){ 
         draw_sprite(buffer,Imagensdahistoria,170,320);
         }
       if(mudarimagens==1){
         draw_sprite(buffer,Imagensdahistoria2,170,320);                  
                             }
